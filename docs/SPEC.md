...
How the app behaves, in detail: the sheet, the editor, every window and
menu, the file formats, the engine's technique and the code layout. The user
guide is [README.md](../README.md), the engine's API is
[packages/core/README.md](../packages/core/README.md) and the testing policy
...
The policy is [TESTING.md](TESTING.md), and it is binding: unit tests
